...
<table border="1">
    ...
    <c:forEach items="${videoList}" var="video" varStatus="STT">
        <tr class="odd gradeX">
            ...
            <td style="text-align: center;"><a href="<c:url value='/admin/category?id=${video.category.categoryId}'/>" class="center">${video.category.categoryId}</a></td>
            ...
            <td style="text-align: center;" width="200">
                ...
                <a style="color: red;" href="<c:url value='/admin/video/delete?id=${video.videoId}'/>" class="center">Delete</a>
            </td>
        </tr>
    </c:forEach>
</table>
